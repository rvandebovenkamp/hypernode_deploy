...
Disallow: /*SID=
            ...
            'twofactorauth' => [
                'duo' => [
                    'application_key' => 'PAAbNhLAssWjYAF3wBGYATnowTphtlDUgrakAsTOmNRmNVk3gYusTkSpDfVRoZCZ',
                ],
            ],
        ],
        'stores' => [
